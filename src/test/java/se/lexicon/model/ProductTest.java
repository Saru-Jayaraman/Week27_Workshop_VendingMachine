...
public class ProductTest {
    ...
    void testGetDescription() {
        Candy candy1 = new Candy(4,"Kit Kat", 20, "Bar");
    ...
    @Order(2)
    void testExamine() {
        Product iceCream1 = new IceCream(1, IceCreamFlavour.MANGO, IceCreamType.CUP, true);
    ...
    @Order(3)
    void testUse() {
        Product doughnut1 = new Doughnut(1, DoughnutSize.MAX, true);
    ...
    void testSetProductName() {
        Candy candy2 = new Candy(1,"Ferraro", 20, "Toffee");
